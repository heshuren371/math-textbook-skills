...
% ── 好题标记适配（兼容现有习题系统）──
% \GoodExercise{label} 放在 exercise 环境内，标记为好题
% \GoodAnswer{label} 放在 answer 环境内，标记解析位置
\makeatletter
\newcommand{\GoodExercise}[1]{%
  \label{prob:#1}%
  \GP@write{\string\GPentry{\theexercise}{#1}}%
}
\newcommand{\GoodAnswer}[1]{%
  \label{sol:#1}%
}
\makeatother
