...
\[
\begin{array}{c|l}
\mathbb{N} & \textbf{自然数集}：\{1,2,3,4,\ldots\} \\
\mathbb{Z} & \textbf{整数集}：\{\ldots,-3,-2,-1,0,1,2,3,\ldots\} \\
\mathbb{Q} & \textbf{有理数集}：可以写成分数 \frac{p}{q}（p,q 是整数，q\neq0）的数 \\
\mathbb{R} & \textbf{实数集}：全体有理数和无理数（如 \sqrt{2},\pi）
\end{array}
\]
